...
function(do_fetch)
  ...
  execute_process(
    COMMAND "C:/MyApp/Git/cmd/git.exe" --git-dir=.git fetch --tags --force "origin"
...
function(get_hash_for_ref ref out_var err_var)
  execute_process(
    COMMAND "C:/MyApp/Git/cmd/git.exe" --git-dir=.git rev-parse "${ref}^0"
    WORKING_DIRECTORY "C:/Users/savch/Study/Base_Cpp/04.homework/build/_deps/sfml-src"
...
execute_process(
  COMMAND "C:/MyApp/Git/cmd/git.exe" --git-dir=.git show-ref "2.6.x"
  WORKING_DIRECTORY "C:/Users/savch/Study/Base_Cpp/04.homework/build/_deps/sfml-src"
...
if(git_update_strategy MATCHES "^REBASE(_CHECKOUT)?$")
  ...
  execute_process(
    COMMAND "C:/MyApp/Git/cmd/git.exe" --git-dir=.git symbolic-ref -q HEAD
    WORKING_DIRECTORY "C:/Users/savch/Study/Base_Cpp/04.homework/build/_deps/sfml-src"
  ...
  if(current_branch STREQUAL "")
    ...
    execute_process(
      COMMAND "C:/MyApp/Git/cmd/git.exe" --git-dir=.git for-each-ref "--format=%(upstream:short)" "${current_branch}"
      WORKING_DIRECTORY "C:/Users/savch/Study/Base_Cpp/04.homework/build/_deps/sfml-src"
...
execute_process(
  COMMAND "C:/MyApp/Git/cmd/git.exe" --git-dir=.git status --porcelain
  WORKING_DIRECTORY "C:/Users/savch/Study/Base_Cpp/04.homework/build/_deps/sfml-src"
  RESULT_VARIABLE error_code
...
if(need_stash)
  execute_process(
    COMMAND "C:/MyApp/Git/cmd/git.exe" --git-dir=.git stash save --quiet;--include-untracked
    WORKING_DIRECTORY "C:/Users/savch/Study/Base_Cpp/04.homework/build/_deps/sfml-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  execute_process(
    COMMAND "C:/MyApp/Git/cmd/git.exe" --git-dir=.git checkout "${checkout_name}"
    WORKING_DIRECTORY "C:/Users/savch/Study/Base_Cpp/04.homework/build/_deps/sfml-src"
    COMMAND_ERROR_IS_FATAL ANY
    ${maybe_show_command}
  )
  ...
  execute_process(
    COMMAND "C:/MyApp/Git/cmd/git.exe" --git-dir=.git rebase "${checkout_name}"
    WORKING_DIRECTORY "C:/Users/savch/Study/Base_Cpp/04.homework/build/_deps/sfml-src"
    RESULT_VARIABLE error_code
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "C:/MyApp/Git/cmd/git.exe" --git-dir=.git rebase --abort
      WORKING_DIRECTORY "C:/Users/savch/Study/Base_Cpp/04.homework/build/_deps/sfml-src"
      ${maybe_show_command}
    )
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      if(need_stash)
        execute_process(
          COMMAND "C:/MyApp/Git/cmd/git.exe" --git-dir=.git stash pop --index --quiet
          WORKING_DIRECTORY "C:/Users/savch/Study/Base_Cpp/04.homework/build/_deps/sfml-src"
          ${maybe_show_command}
          )
      endif()
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/savch/Study/Base_Cpp/04.homework/build/_deps/sfml-src'."
    ...
    execute_process(
      COMMAND "C:/MyApp/Git/cmd/git.exe" --git-dir=.git tag -a
...
if(need_stash)
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "C:/MyApp/Git/cmd/git.exe" --git-dir=.git reset --hard --quiet
      WORKING_DIRECTORY "C:/Users/savch/Study/Base_Cpp/04.homework/build/_deps/sfml-src"
      ${maybe_show_command}
    )
    execute_process(
      COMMAND "C:/MyApp/Git/cmd/git.exe" --git-dir=.git stash pop --quiet
      WORKING_DIRECTORY "C:/Users/savch/Study/Base_Cpp/04.homework/build/_deps/sfml-src"
      RESULT_VARIABLE error_code
      ${maybe_show_command}
    )
    if(error_code)
      ...
      execute_process(
        COMMAND "C:/MyApp/Git/cmd/git.exe" --git-dir=.git reset --hard --quiet ${head_sha}
        WORKING_DIRECTORY "C:/Users/savch/Study/Base_Cpp/04.homework/build/_deps/sfml-src"
        ${maybe_show_command}
      )
      execute_process(
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/savch/Study/Base_Cpp/04.homework/build/_deps/sfml-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
